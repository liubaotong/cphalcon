...
final class RefactorModelsEventsTest extends AbstractDatabaseTestCase
{
    /**
     * @author Phalcon Team <team@phalcon.io>
     * @since  2026-04-02
     */
    public function testEventsFetch(): void
    {
     ...
     * @since  2026-04-02
     */
    public function testEventsUpdate(): void
    {
        $this->markTestSkipped('Needs review - tocheck after migration');
    }
     ...
     * @since  2026-04-02
     */
    public function testEventsDelete(): void
    {
        $this->markTestSkipped('Needs review - tocheck after migration');
    }
}

// Original Cest file content (ModelsEventsCest):
//
// <?php
//
