...
PHP_METHOD(Phalcon_Filter_Validation_Validator_File, __construct)
{
	...
	if (zephir_array_isset_string(&options, SL("messageFileEmpty"))) {
		...
		ZEPHIR_CALL_METHOD(&messageFileEmpty, &helper, "__invoke", NULL, 164, &options, &_0$$3);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string(&options, SL("messageIniSize"))) {
		...
		ZEPHIR_CALL_METHOD(&messageIniSize, &helper, "__invoke", NULL, 164, &options, &_1$$4);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string(&options, SL("messageValid"))) {
		...
		ZEPHIR_CALL_METHOD(&messageValid, &helper, "__invoke", NULL, 164, &options, &_2$$5);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&options) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&options), _5, _6, _3)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_8$$6, "strcasecmp", &_9, 41, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "maxSize");
			ZEPHIR_CALL_FUNCTION(&_10$$6, "strcasecmp", &_9, 41, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "equalSize");
			ZEPHIR_CALL_FUNCTION(&_11$$6, "strcasecmp", &_9, 41, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "allowedTypes");
			ZEPHIR_CALL_FUNCTION(&_12$$6, "strcasecmp", &_9, 41, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "maxResolution");
			ZEPHIR_CALL_FUNCTION(&_13$$6, "strcasecmp", &_9, 41, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "minResolution");
			ZEPHIR_CALL_FUNCTION(&_14$$6, "strcasecmp", &_9, 41, &key, &_7$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_7$$6);
			ZVAL_STRING(&_7$$6, "equalResolution");
			ZEPHIR_CALL_FUNCTION(&_15$$6, "strcasecmp", &_9, 41, &key, &_7$$6);
			zephir_check_call_status();
			if (ZEPHIR_IS_LONG_IDENTICAL(&_8$$6, 0)) {
				ZEPHIR_INIT_NVAR(&_16$$7);
				ZVAL_STRING(&_16$$7, "messageMinSize");
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_16$$7);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_16$$7);
				ZVAL_STRING(&_16$$7, "includedMinSize");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_16$$7);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_18, 325, &_17$$7);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_19$$8);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_19$$8);
				ZVAL_STRING(&_19$$8, "includedSize");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_19$$8);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_18, 325, &_20$$8);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_21$$9);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_18, 325, &_22$$9);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_23$$10);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_18, 325, &_24$$10);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_25$$11);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_25$$11);
				ZVAL_STRING(&_25$$11, "includedMaxResolution");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_25$$11);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_27, 326, &_26$$11);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_28$$12);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_28$$12);
				ZVAL_STRING(&_28$$12, "includedMinResolution");
				ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_28$$12);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_30, 327, &_29$$12);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_31$$13);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&validator);
				...
				ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_32$$13);
				zephir_check_call_status();
			...
			if (Z_TYPE_P(&messageFileEmpty) != IS_NULL) {
				ZEPHIR_CALL_METHOD(NULL, &validator, "setmessagefileempty", &_34, 329, &messageFileEmpty);
				zephir_check_call_status();
			}
			if (Z_TYPE_P(&messageIniSize) != IS_NULL) {
				ZEPHIR_CALL_METHOD(NULL, &validator, "setmessageinisize", &_35, 330, &messageIniSize);
				zephir_check_call_status();
			}
			if (Z_TYPE_P(&messageValid) != IS_NULL) {
				ZEPHIR_CALL_METHOD(NULL, &validator, "setmessagevalid", &_36, 331, &messageValid);
				zephir_check_call_status();
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_38$$18, "strcasecmp", &_9, 41, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "maxSize");
				ZEPHIR_CALL_FUNCTION(&_39$$18, "strcasecmp", &_9, 41, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "equalSize");
				ZEPHIR_CALL_FUNCTION(&_40$$18, "strcasecmp", &_9, 41, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "allowedTypes");
				ZEPHIR_CALL_FUNCTION(&_41$$18, "strcasecmp", &_9, 41, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "maxResolution");
				ZEPHIR_CALL_FUNCTION(&_42$$18, "strcasecmp", &_9, 41, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "minResolution");
				ZEPHIR_CALL_FUNCTION(&_43$$18, "strcasecmp", &_9, 41, &key, &_37$$18);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_37$$18);
				ZVAL_STRING(&_37$$18, "equalResolution");
				ZEPHIR_CALL_FUNCTION(&_44$$18, "strcasecmp", &_9, 41, &key, &_37$$18);
				zephir_check_call_status();
				if (ZEPHIR_IS_LONG_IDENTICAL(&_38$$18, 0)) {
					ZEPHIR_INIT_NVAR(&_45$$19);
					ZVAL_STRING(&_45$$19, "messageMinSize");
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_45$$19);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_45$$19);
					ZVAL_STRING(&_45$$19, "includedMinSize");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_45$$19);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_size_min_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_46$$19);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("messageMinSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedMinSize"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_47$$20);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_47$$20);
					ZVAL_STRING(&_47$$20, "includedSize");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_47$$20);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_size_max_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_48$$20);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("maxSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedSize"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_49$$21);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_size_equal_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_50$$21);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("equalSize"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageEqualSize"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_51$$22);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_mimetype_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_52$$22);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("allowedTypes"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageType"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_53$$23);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_53$$23);
					ZVAL_STRING(&_53$$23, "includedMaxResolution");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_53$$23);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_resolution_max_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_54$$23);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("maxResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedMaxResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageMaxResolution"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_55$$24);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&_55$$24);
					ZVAL_STRING(&_55$$24, "includedMinResolution");
					ZEPHIR_CALL_METHOD(&included, &helper, "__invoke", NULL, 164, &options, &_55$$24);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_resolution_min_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_56$$24);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("minResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("includedMinResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageMinResolution"), PH_SEPARATE);
					...
					ZEPHIR_CALL_METHOD(&message, &helper, "__invoke", NULL, 164, &options, &_57$$25);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&validator);
					object_init_ex(&validator, phalcon_filter_validation_validator_file_resolution_equal_ce);
					...
					ZEPHIR_CALL_METHOD(NULL, &validator, "__construct", &_33, 328, &_58$$25);
					zephir_check_call_status();
					zephir_array_unset_string(&options, SL("equalResolution"), PH_SEPARATE);
					zephir_array_unset_string(&options, SL("messageEqualResolution"), PH_SEPARATE);
				} else {
