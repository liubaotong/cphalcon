...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeDelete)
{
	...
	while (1) {
		...
		/* try_start_1: */
			...
			if (!(zephir_is_true(&_5$$7))) {
				...
				object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
				ZVAL_BOOL(&_7$$8, 0);
				ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 461, &_7$$8, &record);
				zephir_check_call_status_or_jump(try_end_1);
				RETURN_MM();
			}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_11, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 461, &_11);
	zephir_check_call_status();
	RETURN_MM();
}
	...
	if (!(isComplex)) {
		...
		if (_90$$83) {
			...
			if (zephir_is_true(&resultsetClassName)) {
				...
				ZEPHIR_CALL_FUNCTION(&_94$$97, "is_subclass_of", NULL, 444, &resultsetClassName, &_93$$97);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeUpdate)
{
	...
	while (1) {
		...
		/* try_start_1: */
			...
			if (!(zephir_is_true(&_31$$25))) {
				...
				object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
				ZVAL_BOOL(&_33$$26, 0);
				ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 461, &_33$$26, &record);
				zephir_check_call_status_or_jump(try_end_1);
				RETURN_MM();
			}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_37, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 461, &_37);
	zephir_check_call_status();
	RETURN_MM();
}
