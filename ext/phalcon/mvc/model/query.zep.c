...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute)
{
	...
	do {
		if (ZEPHIR_IS_LONG(&type, 309)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executeselect", NULL, 474, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 306)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executeinsert", NULL, 475, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 300)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executeupdate", NULL, 476, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 303)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "executedelete", NULL, 477, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql)
{
	...
	if (ZEPHIR_IS_LONG(&_0, 309)) {
		...
		ZVAL_BOOL(&_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "executeselect", NULL, 474, &intermediate, &_1$$3, &_2$$3, &_3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	if (Z_TYPE_P(&ast) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&type, &ast, SL("type"), 0)) {
			...
			do {
				...
				if (ZEPHIR_IS_LONG(&type, 306)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareinsert", NULL, 479);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 300)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareupdate", NULL, 480);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 303)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_preparedelete", NULL, 481);
					zephir_check_call_status();
					break;
				}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeDelete)
{
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "getrelatedrecords", NULL, 482, &model, &intermediate, &bindParams, &bindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &_2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	while (1) {
		...
		/* try_start_1: */
			...
			if (!(zephir_is_true(&_5$$7))) {
				...
				object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
				ZVAL_BOOL(&_7$$8, 0);
				ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &_7$$8, &record);
				zephir_check_call_status_or_jump(try_end_1);
				RETURN_MM();
			}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_11, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &_11);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeInsert)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &_36, &insertModel);
	zephir_check_call_status();
	RETURN_MM();
}
	...
	if (!(isComplex)) {
		...
		if (_124$$95) {
			...
			if (zephir_is_true(&resultsetClassName)) {
				...
				ZEPHIR_CALL_FUNCTION(&_128$$109, "is_subclass_of", NULL, 466, &resultsetClassName, &_127$$109);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 484, &simpleColumnMap, &resultObject, &resultData, &cache, &_132$$95);
		zephir_check_call_status();
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_resultset_complex_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 485, &columns1, &resultData, &cache);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, executeUpdate)
{
	...
	ZEPHIR_INIT_NVAR(&field);
	ZEPHIR_INIT_NVAR(&number);
	ZEPHIR_CALL_METHOD(&records, this_ptr, "getrelatedrecords", NULL, 482, &model, &intermediate, &selectBindParams, &selectBindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_28$$23, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &_28$$23);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, &bindParams, &bindTypes);
	...
	while (1) {
		...
		/* try_start_1: */
			...
			if (!(zephir_is_true(&_31$$25))) {
				...
				object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
				ZVAL_BOOL(&_33$$26, 0);
				ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &_33$$26, &record);
				zephir_check_call_status_or_jump(try_end_1);
				RETURN_MM();
			}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_37, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 483, &_37);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getCallArgument)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getexpression", NULL, 486, &argument);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getCaseExpression)
{
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (zephir_array_isset_string(&whenExpr, SL("right"))) {
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getexpression", &_6, 486, &_5$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getexpression", &_6, 486, &_7$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "getexpression", &_6, 486, &_10$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_array_isset_string(&whenExpr, SL("right"))) {
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "getexpression", &_6, 486, &_13$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "getexpression", &_6, 486, &_14$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_16$$8, this_ptr, "getexpression", &_6, 486, &_17$$8);
					zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_18, this_ptr, "getexpression", &_6, 486, &_19);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getExpression)
{
	...
	if (zephir_array_isset_string_fetch(&exprType, &expr, SL("type"), 0)) {
		...
		if (!ZEPHIR_IS_LONG(&exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, &expr, SL("left"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "getexpression", NULL, 486, &exprLeft, &_0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, &expr, SL("right"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "getexpression", NULL, 486, &exprRight, &_1$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(&exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "getqualified", NULL, 487, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, '+')) {
			...
			if (ZEPHIR_IS_LONG(&exprType, 350)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "getfunctioncall", NULL, 488, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 409)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "getcaseexpression", NULL, 489, &expr);
				zephir_check_call_status();
				break;
			}
	...
	if (zephir_array_isset_string(&expr, SL("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getqualified", NULL, 487, &expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(&expr, 0)) {
		...
		if (Z_TYPE_P(&expr) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&expr), _86$$72)
			{
				...
				ZEPHIR_CALL_METHOD(&_88$$73, this_ptr, "getexpression", NULL, 486, &exprListItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_89$$74, this_ptr, "getexpression", NULL, 486, &exprListItem);
					zephir_check_call_status();
		...
		if (zephir_array_isset_long(&arguments, 0)) {
			...
			if (Z_TYPE_P(&arguments) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _0$$6)
				{
					...
					ZEPHIR_CALL_METHOD(&_2$$7, this_ptr, "getcallargument", &_3, 490, &argument);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_4$$8, this_ptr, "getcallargument", &_3, 490, &argument);
						zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "getcallargument", &_3, 490, &arguments);
			zephir_check_call_status();
	...
	if (zephir_array_isset_long(&group, 0)) {
		...
		if (Z_TYPE_P(&group) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&group), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "getexpression", &_3, 486, &groupItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "getexpression", &_3, 486, &groupItem);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "getexpression", &_3, 486, &group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getLimitClause)
{
	...
	if (zephir_array_isset_string_fetch(&number, &limitClause, SL("number"), 0)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "getexpression", NULL, 486, &number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, &limitClause, SL("offset"), 0)) {
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "getexpression", NULL, 486, &offset);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getJoins)
{
	...
	if (Z_TYPE_P(&selectJoins) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectJoins), _1)
		{
			...
			ZEPHIR_CALL_METHOD(&joinData, this_ptr, "getjoin", &_3, 491, &manager, &joinItem);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&joinType, this_ptr, "getjointype", &_4, 492, &joinItem);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _21, _22, _19)
		{
			...
			if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
				ZEPHIR_CALL_METHOD(&_23$$18, this_ptr, "getexpression", &_24, 486, &joinExpr);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&joinExpr);
				if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
					ZEPHIR_CALL_METHOD(&_25$$20, this_ptr, "getexpression", &_24, 486, &joinExpr);
					zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0))) {
						...
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							...
							if (!(zephir_is_true(&_55$$32))) {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "getsinglejoin", &_56, 493, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							} else {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "getmultijoin", &_57, 494, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							}
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _3$$3, _4$$3, _1$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_9$$4, this_ptr, "getqualified", &_11, 487, &_10$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$4, this_ptr, "getqualified", &_11, 487, &_12$$4);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_17$$6, this_ptr, "getqualified", &_11, 487, &_18$$6);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_17$$6, this_ptr, "getqualified", &_11, 487, &_19$$6);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 487, &_25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 487, &_26$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 487, &_27$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_23$$8, SL("left"), &_24$$8, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "getqualified", &_11, 487, &_28$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_23$$8, SL("right"), &_24$$8, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(&_22$$8, &_23$$8);
		zephir_array_update_string(&_21$$8, SL("conditions"), &_22$$8, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getOrderClause)
{
	...
	if (Z_TYPE_P(&orderColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&orderColumns), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "getexpression", &_3, 486, &_2$$5);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "getexpression", &_3, 486, &_8$$10);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSelectColumn)
{
	...
	if (ZEPHIR_IS_LONG(&columnType, 354)) {
		...
		ZEPHIR_CALL_METHOD(&sqlExprColumn, this_ptr, "getexpression", NULL, 486, &columnData);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSingleJoin)
{
	...
	if (Z_TYPE_P(&fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getqualified", NULL, 487, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getqualified", NULL, 487, &_4$$3);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _7$$4, _8$$4, _5$$4)
			{
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "getqualified", NULL, 487, &_15$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "getqualified", NULL, 487, &_16$$5);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "getqualified", NULL, 487, &_22$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "getqualified", NULL, 487, &_23$$7);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete)
{
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_10$$17, 1);
		ZEPHIR_CALL_METHOD(&_9$$17, this_ptr, "getexpression", NULL, 486, &where, &_10$$17);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_11$$18, this_ptr, "getlimitclause", NULL, 500, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert)
{
	...
	if (Z_TYPE_P(&_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2), _3)
		{
			...
			ZEPHIR_CALL_METHOD(&_7$$7, this_ptr, "getexpression", &_9, 486, &exprValue, &_8$$7);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_12$$8, this_ptr, "getexpression", &_9, 486, &exprValue, &_13$$8);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect)
{
	...
	if (zephir_fast_count_int(&joins)) {
		...
		ZEPHIR_CALL_METHOD(&sqlJoins, this_ptr, "getjoins", NULL, 501, &select);
		zephir_check_call_status();
	} else {
		if (zephir_fast_count_int(&automaticJoins)) {
			zephir_array_update_string(&select, SL("joins"), &automaticJoins, PH_COPY | PH_SEPARATE);
	...
	if (Z_TYPE_P(&selectColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectColumns), _82)
		{
			...
			ZEPHIR_CALL_METHOD(&_84$$60, this_ptr, "getselectcolumn", &_85, 502, &column);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_94$$75, this_ptr, "getselectcolumn", &_85, 502, &column);
				zephir_check_call_status();
	...
	zephir_memory_observe(&where);
	if (zephir_array_isset_string_fetch(&where, ast, SL("where"), 0)) {
		ZEPHIR_CALL_METHOD(&_104$$92, this_ptr, "getexpression", NULL, 486, &where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&groupBy, ast, SL("groupBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_105$$93, this_ptr, "getgroupclause", NULL, 503, &groupBy);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SL("having"), 0)) {
		ZEPHIR_CALL_METHOD(&_106$$94, this_ptr, "getexpression", NULL, 486, &having);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&order, ast, SL("orderBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_107$$95, this_ptr, "getorderclause", NULL, 504, &order);
		zephir_check_call_status();
		zephir_array_update_string(&sqlSelect, SL("order"), &_107$$95, PH_COPY | PH_SEPARATE);
	}
	zephir_memory_observe(&limit);
	if (zephir_array_isset_string_fetch(&limit, ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_108$$96, this_ptr, "getlimitclause", NULL, 500, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate)
{
	...
	if (Z_TYPE_P(&updateValues) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateValues), _9)
		{
			...
			ZEPHIR_CALL_METHOD(&_11$$20, this_ptr, "getexpression", &_14, 486, &_12$$20, &_13$$20);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_17$$20, this_ptr, "getexpression", &_14, 486, &exprColumn, &_18$$20);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_19$$21, this_ptr, "getexpression", &_14, 486, &_20$$21, &_21$$21);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_24$$21, this_ptr, "getexpression", &_14, 486, &exprColumn, &_25$$21);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_27$$22, 1);
		ZEPHIR_CALL_METHOD(&_26$$22, this_ptr, "getexpression", &_14, 486, &where, &_27$$22);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_26$$22, PH_COPY | PH_SEPARATE);
	}
	zephir_memory_observe(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_28$$23, this_ptr, "getlimitclause", NULL, 500, &limit);
		zephir_check_call_status();
