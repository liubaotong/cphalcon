...
PHP_METHOD(Phalcon_Mvc_Dispatcher, throwDispatchException)
{
	...
	zval message_zv, *exceptionCode_param = NULL, container, response, exception, _0, _4, _5, _1$$3, _2$$3, _3$$3;
	...
	if (Z_TYPE_P(&container) == IS_NULL) {
		...
		ZVAL_LONG(&_3$$3, 0);
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 35, &_2$$3, &_3$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &exception, "__construct", NULL, 35, &message_zv, &_0);
	zephir_check_call_status();
