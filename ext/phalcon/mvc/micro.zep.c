...
PHP_METHOD(Phalcon_Mvc_Micro, getService)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 444);
		zephir_check_call_status();
	...
	/* try_start_1: */
		...
		if (Z_TYPE_P(&matchedRoute) != IS_NULL) {
			...
			if (UNEXPECTED(!(zephir_array_isset_fetch(&handler, &_7$$7, &_8$$7, 0)))) {
				...
				ZVAL_STRING(&_10$$8, "Matched route does not have an associated handler");
				ZEPHIR_CALL_METHOD(NULL, &_9$$8, "__construct", NULL, 35, &_10$$8);
				zephir_check_call_status_or_jump(try_end_1);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&beforeHandlers), _16$$7)
				{
					...
					if (_18$$11) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&before)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_19$$14, "__construct", NULL, 35, &_20$$14);
							zephir_check_call_status_or_jump(try_end_1);
					...
					zephir_check_call_status();
						...
						if (_22$$16) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&before)))) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_23$$19, "__construct", NULL, 35, &_24$$19);
								zephir_check_call_status_or_jump(try_end_1);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&afterBindingHandlers), _42$$7)
				{
					...
					if (_44$$31) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&afterBinding)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_45$$34, "__construct", NULL, 35, &_46$$34);
							zephir_check_call_status_or_jump(try_end_1);
					...
					zephir_check_call_status();
						...
						if (_48$$36) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&afterBinding)))) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_49$$39, "__construct", NULL, 35, &_50$$39);
								zephir_check_call_status_or_jump(try_end_1);
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&afterHandlers), _55$$7)
				{
					...
					if (_57$$42) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&after)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_58$$45, "__construct", NULL, 35, &_59$$45);
							zephir_check_call_status_or_jump(try_end_1);
					...
					zephir_check_call_status();
						...
						if (_61$$47) {
							...
							if (UNEXPECTED(!(zephir_is_callable(&after)))) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_62$$50, "__construct", NULL, 35, &_63$$50);
								zephir_check_call_status_or_jump(try_end_1);
			...
			if (UNEXPECTED(!(zephir_is_callable(&notFoundHandler)))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_70$$55, "__construct", NULL, 35, &_71$$55);
				zephir_check_call_status_or_jump(try_end_1);
			...
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&finishHandlers), _76$$4)
			{
				...
				if (_78$$57) {
					...
					if (UNEXPECTED(!(zephir_is_callable(&finish)))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_79$$60, "__construct", NULL, 35, &_80$$60);
						zephir_check_call_status_or_jump(try_end_1);
				...
				zephir_check_call_status();
					...
					if (_83$$62) {
						...
						if (UNEXPECTED(!(zephir_is_callable(&finish)))) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_84$$65, "__construct", NULL, 35, &_85$$65);
							zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Phalcon_Mvc_Micro, mount)
{
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &lazyHandler, "__construct", NULL, 445, &mainHandler);
		zephir_check_call_status();
	} else {
