...
PHP_METHOD(Phalcon_Autoload_Loader, addDirectory)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "sha256");
	ZEPHIR_CALL_FUNCTION(&_1, "hash", NULL, 71, &_0, &directory_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, addExtension)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "sha256");
	ZEPHIR_CALL_FUNCTION(&_1, "hash", NULL, 71, &_0, &extension_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, addFile)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "sha256");
	ZEPHIR_CALL_FUNCTION(&_1, "hash", NULL, 71, &_0, &file_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, autoload)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "autoloadcheckclasses", NULL, 182, &className_zv);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "autoloadchecknamespaces", NULL, 183, &className_zv);
	zephir_check_call_status();
	...
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "autoloadcheckdirectories", NULL, 184, &_8, &className_zv, &_9);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Autoload_Loader, requireFile)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "call_user_func", NULL, 188, &_0, &file_zv);
	zephir_check_call_status();
