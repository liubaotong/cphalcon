...
PHP_METHOD(Phalcon_Html_Helper_Meta, addHttp)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "addelement", NULL, 358, &_0, &httpEquiv_zv, &content_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Html_Helper_Meta, addName)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "name");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addelement", NULL, 358, &_0, &name_zv, &content_zv);
	zephir_check_call_status();
	RETURN_THIS();
}
