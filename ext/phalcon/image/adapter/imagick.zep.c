...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, __construct)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "check", NULL, 414);
	...
	if (1 == (zephir_file_exists(&_1) == SUCCESS)) {
		...
		if (!zephir_is_true(&_11$$3)) {
			...
			ZEPHIR_CALL_FUNCTION(&_14$$5, "constant", NULL, 121, &_13$$5);
			zephir_check_call_status();
		...
		if (zephir_has_constructor(&_27$$7)) {
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processBackground)
{
	...
	ZVAL_LONG(&_2, green);
	ZVAL_LONG(&_3, blue);
	ZEPHIR_CALL_FUNCTION(&color, "sprintf", NULL, 81, &_0, &_1, &_2, &_3);
	zephir_check_call_status();
	...
	while (1) {
		...
		if (!ZEPHIR_IS_TRUE_IDENTICAL(&_7$$3)) {
			...
			ZEPHIR_CALL_FUNCTION(&_10$$4, "constant", &_11, 121, &_9$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_15$$3, "constant", &_11, 121, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_14$$3);
		ZVAL_STRING(&_14$$3, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_16$$3, "constant", &_11, 121, &_14$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_22$$3, "constant", &_11, 121, &_14$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_23$$3, 0);
		ZVAL_LONG(&_24$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processMask)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "constant", &_7, 121, &_5$$3);
		zephir_check_call_status();
		ZVAL_LONG(&_8$$3, 0);
		ZVAL_LONG(&_9$$3, 0);
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processReflection)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_19$$7, "constant", &_20, 121, &_18$$7);
		zephir_check_call_status();
		ZVAL_LONG(&_21$$7, 0);
		ZVAL_LONG(&_22$$7, 0);
		...
		ZEPHIR_CALL_FUNCTION(&_24$$7, "constant", &_20, 121, &_18$$7);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_18$$7);
		ZVAL_STRING(&_18$$7, "Imagick::CHANNEL_ALPHA");
		ZEPHIR_CALL_FUNCTION(&_25$$7, "constant", &_20, 121, &_18$$7);
		zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_35$$10, "constant", &_20, 121, &_34$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_43$$10, "constant", &_20, 121, &_34$$10);
		zephir_check_call_status();
		ZVAL_LONG(&_44$$10, 0);
		ZVAL_LONG(&_45$$10, 0);
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_49$$13, "constant", &_20, 121, &_48$$13);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processSave)
{
	...
	do {
		if (ZEPHIR_IS_STRING(&extension, "gif")) {
			...
			ZVAL_STRING(&_9$$3, "w");
			ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 142, &file_zv, &_9$$3);
			zephir_check_call_status();
			zephir_read_property(&_10$$3, this_ptr, ZEND_STRL("image"), PH_NOISY_CC | PH_READONLY);
		...
		if (ZEPHIR_IS_STRING(&extension, "jpg") || ZEPHIR_IS_STRING(&extension, "jpeg")) {
			...
			ZEPHIR_CALL_FUNCTION(&_13$$4, "constant", NULL, 121, &_12$$4);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processText)
{
	...
	if (((Z_TYPE_P(offsetX) == IS_TRUE || Z_TYPE_P(offsetX) == IS_FALSE) == 1)) {
		if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
			...
			ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 121, &_6$$7);
			zephir_check_call_status();
			...
			if (_7$$8) {
				...
				ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 121, &_8$$8);
				zephir_check_call_status();
			} else {
			}
		...
		if (zephir_is_true(offsetX)) {
			if (((Z_TYPE_P(offsetY) == IS_TRUE || Z_TYPE_P(offsetY) == IS_FALSE) == 1)) {
				...
				if (_12$$11) {
					...
					ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 121, &_13$$11);
					zephir_check_call_status();
				} else {
				}
				...
				if (ZEPHIR_LT_LONG(&y, 0)) {
					...
					ZEPHIR_CALL_FUNCTION(&gravity, "constant", NULL, 121, &_17$$12);
					zephir_check_call_status();
				} else {
				}
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, processWatermark)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "constant", NULL, 121, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Imagick::CHANNEL_ALPHA");
	ZEPHIR_CALL_FUNCTION(&_3, "constant", NULL, 121, &_1);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$3, "constant", NULL, 121, &_7$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Imagick, check)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "defined", NULL, 120, &_1);
	zephir_check_call_status();
	if (zephir_is_true(&_2)) {
		ZEPHIR_INIT_VAR(&_3$$4);
		ZVAL_STRING(&_3$$4, "Imagick::IMAGICK_EXTNUM");
		ZEPHIR_CALL_FUNCTION(&_4$$4, "constant", NULL, 121, &_3$$4);
		zephir_check_call_status();
