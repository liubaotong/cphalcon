...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addComponentAccess)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 145, &_0, &componentName_zv, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, addInherit)
{
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 145, &_0, &roleName_zv, &_1, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allow)
{
	...
	if (Z_TYPE_P(&rolesArray) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&rolesArray), _2)
		{
			...
			ZVAL_COPY(&role, _2);
			ZVAL_LONG(&_4$$4, 1);
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "allowordeny", &_5, 149, &role, &componentName_zv, access, &_4$$4, func);
			zephir_check_call_status();
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				ZVAL_LONG(&_6$$5, 1);
				ZEPHIR_CALL_METHOD(NULL, this_ptr, "allowordeny", &_5, 149, &role, &componentName_zv, access, &_6$$5, func);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, isAllowed)
{
	...
	ZEPHIR_CALL_METHOD(&accessKey, this_ptr, "canaccess", NULL, 150, roleName, componentName, &access_zv);
	zephir_check_call_status();
	...
	if (zephir_is_callable(&funcAccess)) {
		...
		if (Z_TYPE_P(&reflectionParameters) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reflectionParameters), _15$$15)
			{
				...
				if (_17$$17) {
					...
					ZEPHIR_CALL_METHOD(NULL, &reflectionClass, "__construct", &_18, 154, &className);
					zephir_check_call_status();
					_19$$18 = Z_TYPE_P(&roleObject) != IS_NULL;
					if (_19$$18) {
						ZEPHIR_CALL_METHOD(&_20$$18, &reflectionClass, "isinstance", &_21, 155, &roleObject);
						zephir_check_call_status();
					...
					if (_23$$18) {
						ZEPHIR_CALL_METHOD(&_24$$18, &reflectionClass, "isinstance", &_21, 155, &componentObject);
						zephir_check_call_status();
					...
					if (_28$$18) {
						...
						ZEPHIR_CALL_METHOD(&_29$$18, &reflectionClass, "isinstance", &_21, 155, &_30$$18);
						zephir_check_call_status();
					...
					if (UNEXPECTED(_28$$18)) {
						...
						ZEPHIR_CALL_METHOD(&_34$$21, &reflectionClass, "getname", &_35, 156);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (_38$$23) {
						...
						if (_39$$24) {
							ZEPHIR_CALL_METHOD(&_40$$24, &reflectionClass, "isinstance", &_21, 155, &roleObject);
							zephir_check_call_status();
						...
						if (_42$$24) {
							ZEPHIR_CALL_METHOD(&_43$$24, &reflectionClass, "isinstance", &_21, 155, &componentObject);
							zephir_check_call_status();
						...
						if (_47$$24) {
							...
							ZEPHIR_CALL_METHOD(&_48$$24, &reflectionClass, "isinstance", &_21, 155, &_49$$24);
							zephir_check_call_status();
						...
						if (UNEXPECTED(_47$$24)) {
							...
							ZEPHIR_CALL_METHOD(&_53$$27, &reflectionClass, "getname", &_35, 156);
							zephir_check_call_status();
		...
		if (UNEXPECTED(ZEPHIR_LT_LONG(&userParametersSizeShouldBe, zephir_fast_count_int(&parameters)))) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "trigger_error", NULL, 7, &_56$$29, &_57$$29);
			zephir_check_call_status();
		}
		if (zephir_fast_count_int(&parametersForFunction) == 0) {
			if (UNEXPECTED(ZEPHIR_GT_LONG(&numberOfRequiredParameters, 0))) {
				...
				ZEPHIR_CALL_FUNCTION(NULL, "trigger_error", NULL, 7, &_58$$31);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Acl_Adapter_Memory, allowOrDeny)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "Role");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 145, &_0, &roleName_zv, &_1);
	zephir_check_call_status();
	zephir_read_property(&_2, this_ptr, ZEND_STRL("componentsNames"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "Component");
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkexists", NULL, 145, &_2, &componentName_zv, &_1);
	zephir_check_call_status();
