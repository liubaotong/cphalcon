...
PHP_METHOD(Phalcon_Http_Request, getBasicAuth)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "hasserver", NULL, 341, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getClientAddress)
{
	...
	ZEPHIR_CALL_METHOD(&server, this_ptr, "getserverarray", NULL, 342);
	zephir_check_call_status();
	...
	if (trustForwardedHeader) {
		...
		if (_3$$4) {
			ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "isproxytrusted", NULL, 343, &address);
			zephir_check_call_status();
		...
		if (!(ZEPHIR_IS_EMPTY(&forwarded))) {
			...
			ZEPHIR_CALL_FUNCTION(&forwardedIps, "array_map", NULL, 89, &_6$$8, &_5$$8);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&reverseForwardedIps, "array_reverse", NULL, 300, &forwardedIps);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&reverseForwardedIps) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reverseForwardedIps), _7$$8)
				{
					...
					if (_10$$9) {
						ZEPHIR_CALL_METHOD(&_11$$9, this_ptr, "isproxytrusted", NULL, 343, &forwardedIp);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&filteredIp, this_ptr, "isvalidpublicip", &_12, 344, &forwardedIp);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (_14$$12) {
							ZEPHIR_CALL_METHOD(&_15$$12, this_ptr, "isproxytrusted", NULL, 343, &forwardedIp);
							zephir_check_call_status();
	...
	if (Z_TYPE_P(&server) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&server), _2, _3, _0)
		{
			...
			if (zephir_start_with_str(&name, SL("HTTP_"))) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 292, &_4$$4);
				zephir_check_call_status();
			...
			if (zephir_array_isset(&contentHeaders, &name)) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 292, &_15$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_start_with_str(&name, SL("HTTP_"))) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 292, &_22$$7);
					zephir_check_call_status();
				...
				if (zephir_array_isset(&contentHeaders, &name)) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 292, &_32$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost)
{
	...
	if (_3) {
		...
		if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_11$$5, &_10$$5))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", NULL, 345, &_13$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getJsonRawBody)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(&_0, "__invoke", NULL, 199, &rawBody, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getPatch)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getpostdata", NULL, 346, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPort)
{
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 729)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 244, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPost)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getpostdata", NULL, 346, &_POST);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("postCache"), &_0);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("postCache"), PH_NOISY_CC | PH_READONLY);
	if (notAllowEmpty) {
...
PHP_METHOD(Phalcon_Http_Request, getServerAddress)
{
	...
	if (Z_TYPE_P(&serverAddr) == IS_NULL) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("gethostbyname", NULL, 347, &_1$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
				...
				if (Z_TYPE_P(&_4$$4) == IS_ARRAY) {
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _11$$5)
						{
							...
							if (_13$$6) {
								...
								if (namedKeys == 1) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_16$$8, "__construct", &_18, 348, &dataFile, &_17$$8);
									zephir_check_call_status();
									...
									ZEPHIR_CALL_METHOD(NULL, &_20$$9, "__construct", &_18, 348, &dataFile, &_21$$9);
									zephir_check_call_status();
							...
							zephir_check_call_status();
								...
								if (_22$$10) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_26$$12, "__construct", &_18, 348, &dataFile, &_27$$12);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_29$$13, "__construct", &_18, 348, &dataFile, &_30$$13);
										zephir_check_call_status();
					...
					if (_31$$14) {
						if (namedKeys == 1) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_33$$16, "__construct", &_18, 348, &input, &prefix);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_METHOD(NULL, &_34$$17, "__construct", &_18, 348, &input, &prefix);
							zephir_check_call_status();
					...
					if (Z_TYPE_P(&_35$$18) == IS_ARRAY) {
							...
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _41$$19)
							{
								...
								if (_43$$20) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_47$$22, "__construct", &_18, 348, &dataFile, &_48$$22);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_50$$23, "__construct", &_18, 348, &dataFile, &_51$$23);
										zephir_check_call_status();
								...
								zephir_check_call_status();
									...
									if (_52$$24) {
										...
										if (namedKeys == 1) {
											...
											ZEPHIR_CALL_METHOD(NULL, &_56$$26, "__construct", &_18, 348, &dataFile, &_57$$26);
											zephir_check_call_status();
											...
											ZEPHIR_CALL_METHOD(NULL, &_59$$27, "__construct", &_18, 348, &dataFile, &_60$$27);
											zephir_check_call_status();
						...
						if (_61$$28) {
							if (namedKeys == 1) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_63$$30, "__construct", &_18, 348, &input, &prefix);
								zephir_check_call_status();
								...
								ZEPHIR_CALL_METHOD(NULL, &_64$$31, "__construct", &_18, 348, &input, &prefix);
								zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, hasHeader)
{
	...
	ZEPHIR_INIT_VAR(&name);
	zephir_fast_strtoupper(&name, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "hasserver", NULL, 341, &name);
	zephir_check_call_status();
	_4 = zephir_is_true(&_3);
	if (!(_4)) {
		ZEPHIR_INIT_VAR(&_6);
		ZEPHIR_CONCAT_SV(&_6, "HTTP_", &name);
		ZEPHIR_CALL_METHOD(&_5, this_ptr, "hasserver", NULL, 341, &_6);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isJson)
{
	...
	if (_2) {
		...
		ZEPHIR_INIT_NVAR(&_1);
		ZVAL_STRING(&_1, "json");
		ZEPHIR_CALL_FUNCTION(&_4, "stripos", NULL, 349, &_3, &_1);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(methods) == IS_ARRAY) {
		...
		if (Z_TYPE_P(methods) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(methods), _4$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "ismethod", &_8, 350, &method, &_7$$6);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_9$$8, this_ptr, "ismethod", &_8, 350, &method, &_10$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, setParameterFilters)
{
	...
	ZEPHIR_CALL_METHOD(&filterService, this_ptr, "getfilterservice", NULL, 351);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, setTrustedProxyHeader)
{
	...
	ZEPHIR_CALL_FUNCTION(&_4, "str_starts_with", NULL, 337, &trustedHeader, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isIpAddressInCIDR)
{
	...
	ZEPHIR_CALL_FUNCTION(&ipBin, "inet_pton", NULL, 352, &ip_zv);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&subnetBin, "inet_pton", NULL, 352, &subnet);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&ipBits, "unpack", NULL, 271, &_3, &ipBin);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&subnetBits, "unpack", NULL, 271, &_3, &subnetBin);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "0");
	ZEPHIR_CALL_FUNCTION(&_6, "str_pad", NULL, 353, &ipBits, &_5, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&ipBits, "hex2bin", NULL, 354, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, zephir_fast_strlen_ev(&subnetBits));
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "0");
	ZEPHIR_CALL_FUNCTION(&_7, "str_pad", NULL, 353, &subnetBits, &_5, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&subnetBits, "hex2bin", NULL, 354, &_7);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_9, "strncmp", NULL, 193, &ipBits, &subnetBits, &_8);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(data), _0)
		{
			...
			if (Z_TYPE_P(&value) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "hasfilehelper", &_5, 355, &value, &_4$$7);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&value) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_7$$11, this_ptr, "hasfilehelper", &_5, 355, &value, &_8$$11);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getQualityHeader)
{
	...
	ZVAL_LONG(&_2, -1);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&parts, "preg_split", NULL, 77, &_1, &serverValue, &_2, &_3);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&parts), _4)
		{
			...
			ZVAL_LONG(&_8$$3, -1);
			ZVAL_LONG(&_9$$3, 1);
			ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 77, &_7$$3, &_6$$3, &_8$$3, &_9$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_30$$14, -1);
				ZVAL_LONG(&_31$$14, 1);
				ZEPHIR_CALL_FUNCTION(&headerSplit, "preg_split", NULL, 77, &_29$$14, &_28$$14, &_30$$14, &_31$$14);
				zephir_check_call_status();
				zephir_is_iterable(&headerSplit, 0, "phalcon/Http/Request.zep", 1657);
				if (Z_TYPE_P(&headerSplit) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "hasserver", NULL, 341, &_8);
	zephir_check_call_status();
	_9 = zephir_is_true(&_0);
	if (_9) {
		ZEPHIR_INIT_NVAR(&_8);
		ZVAL_STRING(&_8, "PHP_AUTH_PW");
		ZEPHIR_CALL_METHOD(&_10, this_ptr, "hasserver", NULL, 341, &_8);
		zephir_check_call_status();
	...
	if (_9) {
		...
		ZEPHIR_CALL_METHOD(&_14$$8, this_ptr, "hasserver", NULL, 341, &_15$$8);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_15$$8);
		ZVAL_STRING(&_15$$8, "REDIRECT_HTTP_AUTHORIZATION");
		ZEPHIR_CALL_METHOD(&_16$$8, this_ptr, "hasserver", NULL, 341, &_15$$8);
		zephir_check_call_status();
		...
		if (zephir_is_true(&authHeader)) {
			...
			if (_22$$11) {
				...
				ZEPHIR_CALL_METHOD(&_23$$11, this_ptr, "hasserver", NULL, 341, &_19$$11);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_LONG_IDENTICAL(&_20$$11, 0)) {
				...
				ZEPHIR_CALL_FUNCTION(&_27$$12, "base64_decode", NULL, 233, &_26$$12);
				zephir_check_call_status();
	...
	if (!(zephir_array_isset_string(&headers, SL("Authorization")))) {
		...
		if (zephir_array_isset_string(&headers, SL("Php-Auth-User"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_33$$17, "base64_encode", NULL, 234, &_32$$17);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&names) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&names), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(&name) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 356, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &_10$$5, &p);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&name) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 356, &_16$$10, &_17$$10, &_18$$10, &_19$$10, &_20$$10, &p);
					zephir_check_call_status();
					zephir_is_iterable(&parentFiles, 0, "phalcon/Http/Request.zep", 1793);
					if (Z_TYPE_P(&parentFiles) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Http_Request, getPostData)
{
	...
	if (ZEPHIR_IS_EMPTY(data)) {
		...
		if (_2$$3) {
			...
			ZEPHIR_CALL_FUNCTION(&_5$$3, "stripos", NULL, 349, &_3$$3, &_4$$3);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_0$$3)) {
			...
			ZEPHIR_CALL_METHOD(&result, this_ptr, "getformdata", NULL, 357);
			zephir_check_call_status();
		} else {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 358, &_7$$6, &result);
			ZEPHIR_UNREF(&result);
			zephir_check_call_status();
		}
	} else {
...
PHP_METHOD(Phalcon_Http_Request, getFormData)
{
	...
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "/");
	ZEPHIR_CALL_FUNCTION(&_5, "preg_quote", NULL, 359, &boundary, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	ZEPHIR_CONCAT_SVS(&_6, "/\\R?-+", &_5, "/s");
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "getrawbody", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&bodyParts, "preg_split", NULL, 77, &_6, &_7);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(&bodyParts);
	ZEPHIR_CALL_FUNCTION(NULL, "array_pop", NULL, 360, &bodyParts);
	...
	if (Z_TYPE_P(&bodyParts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&bodyParts), _8)
		{
			...
			ZVAL_LONG(&_11$$3, 2);
			ZEPHIR_CALL_FUNCTION(&splited$$3, "preg_split", NULL, 77, &_10$$3, &bodyPart, &_11$$3);
			zephir_check_call_status();
			...
			ZVAL_LONG(&_11$$3, -1);
			ZVAL_LONG(&_13$$3, 1);
			ZEPHIR_CALL_FUNCTION(&headerParts$$3, "preg_split", NULL, 77, &_10$$3, &_12$$3, &_11$$3, &_13$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_71$$25, 2);
				ZEPHIR_CALL_FUNCTION(&splited$$25, "preg_split", NULL, 77, &_70$$25, &bodyPart, &_71$$25);
				zephir_check_call_status();
				...
				ZVAL_LONG(&_71$$25, -1);
				ZVAL_LONG(&_73$$25, 1);
				ZEPHIR_CALL_FUNCTION(&headerParts$$25, "preg_split", NULL, 77, &_70$$25, &_72$$25, &_71$$25, &_73$$25);
				zephir_check_call_status();
