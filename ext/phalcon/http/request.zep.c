...
PHP_METHOD(Phalcon_Http_Request, getClientAddress)
{
	...
	if (trustForwardedHeader) {
		...
		if (_3$$4) {
			ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "isproxytrusted", NULL, 340, &address);
			zephir_check_call_status();
		...
		if (!(ZEPHIR_IS_EMPTY(&forwarded))) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&reverseForwardedIps, "array_reverse", NULL, 297, &forwardedIps);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&reverseForwardedIps) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reverseForwardedIps), _7$$8)
				{
					...
					if (_10$$9) {
						ZEPHIR_CALL_METHOD(&_11$$9, this_ptr, "isproxytrusted", NULL, 340, &forwardedIp);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&filteredIp, this_ptr, "isvalidpublicip", &_12, 341, &forwardedIp);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (_14$$12) {
							ZEPHIR_CALL_METHOD(&_15$$12, this_ptr, "isproxytrusted", NULL, 340, &forwardedIp);
							zephir_check_call_status();
	...
	if (Z_TYPE_P(&server) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&server), _2, _3, _0)
		{
			...
			if (zephir_start_with_str(&name, SL("HTTP_"))) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 289, &_4$$4);
				zephir_check_call_status();
			...
			if (zephir_array_isset(&contentHeaders, &name)) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 289, &_15$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_start_with_str(&name, SL("HTTP_"))) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 289, &_22$$7);
					zephir_check_call_status();
				...
				if (zephir_array_isset(&contentHeaders, &name)) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 289, &_32$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost)
{
	...
	if (_3) {
		...
		if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_11$$5, &_10$$5))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", NULL, 342, &_13$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPatch)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getpostdata", NULL, 343, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPost)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getpostdata", NULL, 343, &_POST);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("postCache"), &_0);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("postCache"), PH_NOISY_CC | PH_READONLY);
	if (notAllowEmpty) {
...
PHP_METHOD(Phalcon_Http_Request, isJson)
{
	...
	if (_2) {
		...
		ZEPHIR_INIT_NVAR(&_1);
		ZVAL_STRING(&_1, "json");
		ZEPHIR_CALL_FUNCTION(&_4, "stripos", NULL, 346, &_3, &_1);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, setTrustedProxyHeader)
{
	...
	ZEPHIR_CALL_FUNCTION(&_4, "str_starts_with", NULL, 334, &trustedHeader, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isIpAddressInCIDR)
{
	...
	ZEPHIR_CALL_FUNCTION(&ipBin, "inet_pton", NULL, 349, &ip_zv);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&ipBits, "unpack", NULL, 268, &_3, &ipBin);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&subnetBits, "unpack", NULL, 268, &_3, &subnetBin);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "0");
	ZEPHIR_CALL_FUNCTION(&_6, "str_pad", NULL, 350, &ipBits, &_5, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&ipBits, "hex2bin", NULL, 351, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, zephir_fast_strlen_ev(&subnetBits));
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "0");
	ZEPHIR_CALL_FUNCTION(&_7, "str_pad", NULL, 350, &subnetBits, &_5, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&subnetBits, "hex2bin", NULL, 351, &_7);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_9, "strncmp", NULL, 190, &ipBits, &subnetBits, &_8);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders)
{
	...
	if (_9) {
		...
		if (zephir_is_true(&authHeader)) {
			...
			ZEPHIR_CALL_FUNCTION(&_20$$11, "stripos", NULL, 346, &authHeader, &_19$$11);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_19$$11);
			ZVAL_STRING(&_19$$11, "digest ");
			ZEPHIR_CALL_FUNCTION(&_21$$11, "stripos", NULL, 346, &authHeader, &_19$$11);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_24$$11, "stripos", NULL, 346, &authHeader, &_19$$11);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPostData)
{
	...
	if (ZEPHIR_IS_EMPTY(data)) {
		...
		if (_2$$3) {
			...
			ZEPHIR_CALL_FUNCTION(&_5$$3, "stripos", NULL, 346, &_3$$3, &_4$$3);
			zephir_check_call_status();
