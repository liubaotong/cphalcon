...
PHP_METHOD(Phalcon_Http_Request, getClientAddress)
{
	...
	if (trustForwardedHeader) {
		...
		if (_3$$4) {
			ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "isproxytrusted", NULL, 342, &address);
			zephir_check_call_status();
		...
		if (!(ZEPHIR_IS_EMPTY(&forwarded))) {
			...
			ZEPHIR_CALL_FUNCTION(&forwardedIps, "array_map", NULL, 83, &_6$$8, &_5$$8);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&reverseForwardedIps, "array_reverse", NULL, 299, &forwardedIps);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&reverseForwardedIps) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&reverseForwardedIps), _7$$8)
				{
					...
					if (_10$$9) {
						ZEPHIR_CALL_METHOD(&_11$$9, this_ptr, "isproxytrusted", NULL, 342, &forwardedIp);
						zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&filteredIp, this_ptr, "isvalidpublicip", &_12, 343, &forwardedIp);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (_14$$12) {
							ZEPHIR_CALL_METHOD(&_15$$12, this_ptr, "isproxytrusted", NULL, 342, &forwardedIp);
							zephir_check_call_status();
	...
	if (Z_TYPE_P(&server) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&server), _2, _3, _0)
		{
			...
			if (zephir_start_with_str(&name, SL("HTTP_"))) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 291, &_4$$4);
				zephir_check_call_status();
			...
			if (zephir_array_isset(&contentHeaders, &name)) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 291, &_15$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_start_with_str(&name, SL("HTTP_"))) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 291, &_22$$7);
					zephir_check_call_status();
				...
				if (zephir_array_isset(&contentHeaders, &name)) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 291, &_32$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost)
{
	...
	if (_3) {
		...
		if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_11$$5, &_10$$5))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", NULL, 344, &_13$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getJsonRawBody)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(&_0, "__invoke", NULL, 198, &rawBody, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Http_Request, getPatch)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getpostdata", NULL, 345, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPort)
{
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 729)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 243, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPost)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getpostdata", NULL, 345, &_POST);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("postCache"), &_0);
	zephir_read_property(&_1, this_ptr, ZEND_STRL("postCache"), PH_NOISY_CC | PH_READONLY);
	if (notAllowEmpty) {
...
PHP_METHOD(Phalcon_Http_Request, getServerAddress)
{
	...
	if (Z_TYPE_P(&serverAddr) == IS_NULL) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("gethostbyname", NULL, 346, &_1$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
				...
				if (Z_TYPE_P(&_4$$4) == IS_ARRAY) {
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _11$$5)
						{
							...
							if (_13$$6) {
								...
								if (namedKeys == 1) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_16$$8, "__construct", &_18, 347, &dataFile, &_17$$8);
									zephir_check_call_status();
									...
									ZEPHIR_CALL_METHOD(NULL, &_20$$9, "__construct", &_18, 347, &dataFile, &_21$$9);
									zephir_check_call_status();
							...
							zephir_check_call_status();
								...
								if (_22$$10) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_26$$12, "__construct", &_18, 347, &dataFile, &_27$$12);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_29$$13, "__construct", &_18, 347, &dataFile, &_30$$13);
										zephir_check_call_status();
					...
					if (_31$$14) {
						if (namedKeys == 1) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_33$$16, "__construct", &_18, 347, &input, &prefix);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_METHOD(NULL, &_34$$17, "__construct", &_18, 347, &input, &prefix);
							zephir_check_call_status();
					...
					if (Z_TYPE_P(&_35$$18) == IS_ARRAY) {
							...
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _41$$19)
							{
								...
								if (_43$$20) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_47$$22, "__construct", &_18, 347, &dataFile, &_48$$22);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_50$$23, "__construct", &_18, 347, &dataFile, &_51$$23);
										zephir_check_call_status();
								...
								zephir_check_call_status();
									...
									if (_52$$24) {
										...
										if (namedKeys == 1) {
											...
											ZEPHIR_CALL_METHOD(NULL, &_56$$26, "__construct", &_18, 347, &dataFile, &_57$$26);
											zephir_check_call_status();
											...
											ZEPHIR_CALL_METHOD(NULL, &_59$$27, "__construct", &_18, 347, &dataFile, &_60$$27);
											zephir_check_call_status();
						...
						if (_61$$28) {
							if (namedKeys == 1) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_63$$30, "__construct", &_18, 347, &input, &prefix);
								zephir_check_call_status();
								...
								ZEPHIR_CALL_METHOD(NULL, &_64$$31, "__construct", &_18, 347, &input, &prefix);
								zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isJson)
{
	...
	if (_2) {
		...
		ZEPHIR_INIT_NVAR(&_1);
		ZVAL_STRING(&_1, "json");
		ZEPHIR_CALL_FUNCTION(&_4, "stripos", NULL, 348, &_3, &_1);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(methods) == IS_ARRAY) {
		...
		if (Z_TYPE_P(methods) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(methods), _4$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "ismethod", &_8, 349, &method, &_7$$6);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_9$$8, this_ptr, "ismethod", &_8, 349, &method, &_10$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, setTrustedProxyHeader)
{
	...
	ZEPHIR_CALL_FUNCTION(&_4, "str_starts_with", NULL, 336, &trustedHeader, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isIpAddressInCIDR)
{
	...
	ZEPHIR_CALL_FUNCTION(&ipBin, "inet_pton", NULL, 351, &ip_zv);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&subnetBin, "inet_pton", NULL, 351, &subnet);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&ipBits, "unpack", NULL, 270, &_3, &ipBin);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "H*");
	ZEPHIR_CALL_FUNCTION(&subnetBits, "unpack", NULL, 270, &_3, &subnetBin);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "0");
	ZEPHIR_CALL_FUNCTION(&_6, "str_pad", NULL, 352, &ipBits, &_5, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&ipBits, "hex2bin", NULL, 353, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, zephir_fast_strlen_ev(&subnetBits));
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "0");
	ZEPHIR_CALL_FUNCTION(&_7, "str_pad", NULL, 352, &subnetBits, &_5, &_3);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&subnetBits, "hex2bin", NULL, 353, &_7);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_9, "strncmp", NULL, 192, &ipBits, &subnetBits, &_8);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(data), _0)
		{
			...
			if (Z_TYPE_P(&value) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "hasfilehelper", &_5, 354, &value, &_4$$7);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&value) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_7$$11, this_ptr, "hasfilehelper", &_5, 354, &value, &_8$$11);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders)
{
	...
	if (_9) {
		...
		if (zephir_is_true(&authHeader)) {
			...
			if (ZEPHIR_IS_LONG_IDENTICAL(&_20$$11, 0)) {
				...
				ZEPHIR_CALL_FUNCTION(&_27$$12, "base64_decode", NULL, 232, &_26$$12);
				zephir_check_call_status();
	...
	if (!(zephir_array_isset_string(&headers, SL("Authorization")))) {
		...
		if (zephir_array_isset_string(&headers, SL("Php-Auth-User"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_33$$17, "base64_encode", NULL, 233, &_32$$17);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&names) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&names), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(&name) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 355, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &_10$$5, &p);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&name) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 355, &_16$$10, &_17$$10, &_18$$10, &_19$$10, &_20$$10, &p);
					zephir_check_call_status();
					zephir_is_iterable(&parentFiles, 0, "phalcon/Http/Request.zep", 1793);
					if (Z_TYPE_P(&parentFiles) == IS_ARRAY) {
...
PHP_METHOD(Phalcon_Http_Request, getPostData)
{
	...
	if (ZEPHIR_IS_EMPTY(data)) {
		...
		if (_2$$3) {
			...
			ZEPHIR_CALL_FUNCTION(&_5$$3, "stripos", NULL, 348, &_3$$3, &_4$$3);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_0$$3)) {
			...
			ZEPHIR_CALL_METHOD(&result, this_ptr, "getformdata", NULL, 356);
			zephir_check_call_status();
		} else {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 357, &_7$$6, &result);
			ZEPHIR_UNREF(&result);
			zephir_check_call_status();
		}
	} else {
...
PHP_METHOD(Phalcon_Http_Request, getFormData)
{
	...
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "/");
	ZEPHIR_CALL_FUNCTION(&_5, "preg_quote", NULL, 358, &boundary, &_4);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "array_pop", NULL, 359, &bodyParts);
