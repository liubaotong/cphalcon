...
PHP_METHOD(Phalcon_Http_Cookie, send)
{
	...
	ZEPHIR_CALL_METHOD(&_13, this_ptr, "getarrval", NULL, 364, &options, &_3, &expire);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("expires"), &_13, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "domain");
	ZEPHIR_CALL_METHOD(&_14, this_ptr, "getarrval", NULL, 364, &options, &_3, &domain);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("domain"), &_14, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "path");
	ZEPHIR_CALL_METHOD(&_15, this_ptr, "getarrval", NULL, 364, &options, &_3, &path);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("path"), &_15, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "secure");
	ZEPHIR_CALL_METHOD(&_16, this_ptr, "getarrval", NULL, 364, &options, &_3, &secure);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("secure"), &_16, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_NVAR(&_3);
	ZVAL_STRING(&_3, "httponly");
	ZEPHIR_CALL_METHOD(&_17, this_ptr, "getarrval", NULL, 364, &options, &_3, &httpOnly);
	zephir_check_call_status();
	zephir_array_update_string(&options, SL("httponly"), &_17, PH_COPY | PH_SEPARATE);
	ZEPHIR_CALL_FUNCTION(NULL, "setcookie", NULL, 365, &name, &encryptValue, &options);
	zephir_check_call_status();
	RETURN_THIS();
}
