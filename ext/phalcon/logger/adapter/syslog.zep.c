...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, close)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("closelog", NULL, 417);
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, process)
{
	...
	if (!zephir_is_true(&result)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 416, &_8$$3);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&level, this_ptr, "logleveltosyslog", NULL, 418, &_9);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "syslog", NULL, 419, &level, &message);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, openlog)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("openlog", NULL, 420, &ident_zv, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
