...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, __construct)
{
	...
	zval options;
	zval name_zv, *options_param = NULL, facility, option;
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, close)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("closelog", NULL, 438);
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, process)
{
	...
	if (!zephir_is_true(&result)) {
		...
		ZEPHIR_CALL_FUNCTION(&_8$$3, "sprintf", NULL, 76, &_7$$3, &_4$$3, &_6$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 437, &_8$$3);
		zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&level, this_ptr, "logleveltosyslog", NULL, 439, &_9);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "syslog", NULL, 440, &level, &message);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Phalcon_Logger_Adapter_Syslog, openlog)
{
	...
	zval ident_zv, *option_param = NULL, *facility_param = NULL, _0, _1;
	...
	ZEPHIR_RETURN_CALL_FUNCTION("openlog", NULL, 441, &ident_zv, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
