...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, addColumn)
{
	...
	zval tableName_zv, schemaName_zv, *column, column_sub, columnDefinition, _0, _1, _2, _3, _4, _7, _5$$3, _6$$3;
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, addForeignKey)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "getcolumnlist", NULL, 60, &_9);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_10);
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, addIndex)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval tableName_zv, schemaName_zv, *index, index_sub, indexType, _0, _2, _3, _4, _5, _6, _7, _1$$4;
	zend_string *tableName = NULL, *schemaName = NULL;
	zval *this_ptr = getThis();
...
{
	zval indexSql, indexSqlAfterCreate, columnLine, referenceSql, sql, _86;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zephir_fcall_cache_entry *_4 = NULL, *_9 = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval definition, createLines, primaryColumns;
	zval tableName_zv, schemaName_zv, *definition_param = NULL, temporary, options, table, columns, column, indexes, index, reference, references, indexName, indexType, onDelete, onUpdate, columnDefinition, *_2, _3, _82, _83, _0$$5, _1$$6, _5$$7, _6$$7, _7$$7, _11$$7, _12$$7, _14$$7, _8$$8, _10$$8, _13$$11, _15$$12, _16$$12, _17$$12, _18$$13, _19$$13, _20$$13, _23$$13, _24$$13, _26$$13, _21$$14, _22$$14, _25$$17, _27$$18, _28$$18, _29$$18, _30$$19, _31$$19, *_32$$20, _33$$20, _34$$22, _35$$22, _36$$22, _37$$24, _38$$24, _39$$24, _40$$25, _41$$25, _42$$25, _43$$25, _44$$25, _45$$25, _46$$28, _47$$28, _48$$28, _49$$30, _50$$30, _51$$30, _52$$31, _53$$31, _54$$31, _55$$31, _56$$31, _57$$31, *_58$$33, _59$$33, _60$$34, _61$$34, _62$$34, _63$$34, _64$$34, _65$$34, _66$$34, _67$$34, _68$$34, _69$$35, _70$$36, _71$$37, _72$$37, _73$$37, _74$$37, _75$$37, _76$$37, _77$$37, _78$$37, _79$$37, _80$$38, _81$$39, _84$$40, _85$$40;
	zend_string *tableName = NULL, *schemaName = NULL;
	zval *this_ptr = getThis();
	...
	if (!(ZEPHIR_IS_EMPTY(&primaryColumns))) {
		ZEPHIR_CALL_METHOD(&_30$$19, this_ptr, "getcolumnlist", NULL, 60, &primaryColumns);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _32$$20)
			{
				...
				if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_34$$22, this_ptr, "getcolumnlist", NULL, 60, &_35$$22);
					zephir_check_call_status();
					...
					if (!(ZEPHIR_IS_EMPTY(&indexType))) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_37$$24, this_ptr, "getcolumnlist", NULL, 60, &_38$$24);
						zephir_check_call_status();
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_41$$25, this_ptr, "preparetable", NULL, 0, &tableName_zv, &schemaName_zv);
						zephir_check_call_status();
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_43$$25, this_ptr, "getcolumnlist", NULL, 60, &_44$$25);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_46$$28, this_ptr, "getcolumnlist", NULL, 60, &_47$$28);
						zephir_check_call_status();
						...
						if (!(ZEPHIR_IS_EMPTY(&indexType))) {
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_49$$30, this_ptr, "getcolumnlist", NULL, 60, &_50$$30);
							zephir_check_call_status();
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_53$$31, this_ptr, "preparetable", NULL, 0, &tableName_zv, &schemaName_zv);
							zephir_check_call_status();
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_55$$31, this_ptr, "getcolumnlist", NULL, 60, &_56$$31);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _58$$33)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_61$$34, this_ptr, "getcolumnlist", NULL, 60, &_62$$34);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_64$$34, this_ptr, "preparetable", NULL, 0, &_65$$34, &schemaName_zv);
				zephir_check_call_status();
				zephir_concat_self(&referenceSql, &_64$$34);
				ZEPHIR_CALL_METHOD(&_67$$34, &reference, "getreferencedcolumns", NULL, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_66$$34, this_ptr, "getcolumnlist", NULL, 60, &_67$$34);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_72$$37, this_ptr, "getcolumnlist", NULL, 60, &_73$$37);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_75$$37, this_ptr, "preparetable", NULL, 0, &_76$$37, &schemaName_zv);
					zephir_check_call_status();
					zephir_concat_self(&referenceSql, &_75$$37);
					ZEPHIR_CALL_METHOD(&_78$$37, &reference, "getreferencedcolumns", NULL, 0);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_77$$37, this_ptr, "getcolumnlist", NULL, 60, &_78$$37);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, getColumnDefinition)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *column, column_sub, columnType, columnSql, typeValues, _0$$4, _1$$9, _2$$15, _3$$20, _4$$35, _5$$38, _6$$38, _7$$38, value$$40, *_8$$40, _9$$40, _17$$40, _18$$40, _19$$40, _20$$40, _10$$41, _11$$41, _13$$41, _14$$42, _15$$42, _16$$42, _21$$43, _22$$43, _23$$43;
	zval *this_ptr = getThis();
	...
	do {
		...
		if (!(ZEPHIR_IS_EMPTY(&typeValues))) {
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				zephir_is_iterable(&typeValues, 0, "phalcon/Db/Dialect/Postgresql.zep", 533);
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
...
{
	zend_bool _6, _7, _8, _9, _3$$3, _4$$3;
	zval preparedValue, _1$$3, _10$$5;
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *column, column_sub, defaultValue, columnDefinition, columnType, _0, _5, boolStr$$3, _2$$3, _11$$6, _12$$6, _13$$6;
	zval *this_ptr = getThis();
	...
	if (zephir_memnstr_str(&_0, SL("BOOLEAN"), "phalcon/Db/Dialect/Postgresql.zep", 701)) {
		zephir_cast_to_string(&_1$$3, &defaultValue);
		ZEPHIR_INIT_VAR(&boolStr$$3);
		zephir_fast_strtolower(&boolStr$$3, &_1$$3);
		ZEPHIR_CPY_WRT(&boolStr$$3, &boolStr$$3);
		ZEPHIR_INIT_VAR(&_2$$3);
		_3$$3 = ZEPHIR_IS_STRING(&boolStr$$3, "false");
		if (!(_3$$3)) {
			_3$$3 = ZEPHIR_IS_STRING(&boolStr$$3, "0");
		}
		_4$$3 = _3$$3;
		if (!(_4$$3)) {
			_4$$3 = ZEPHIR_IS_STRING(&boolStr$$3, "");
		}
		if (_4$$3) {
			ZEPHIR_INIT_NVAR(&_2$$3);
			ZVAL_STRING(&_2$$3, "false");
		} else {
			ZEPHIR_INIT_NVAR(&_2$$3);
			ZVAL_STRING(&_2$$3, "true");
		}
		RETURN_CCTOR(&_2$$3);
	}
	ZEPHIR_INIT_VAR(&_5);
	zephir_fast_strtoupper(&_5, &defaultValue);
	if (zephir_memnstr_str(&_5, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Postgresql.zep", 707)) {
		RETURN_MM_STRING("CURRENT_TIMESTAMP");
	}
	_6 = ZEPHIR_IS_LONG_IDENTICAL(&columnType, 0);
	if (!(_6)) {
		_6 = ZEPHIR_IS_LONG_IDENTICAL(&columnType, 14);
	}
	_7 = _6;
	if (!(_7)) {
		_7 = ZEPHIR_IS_LONG_IDENTICAL(&columnType, 3);
	}
	_8 = _7;
	if (!(_8)) {
		_8 = ZEPHIR_IS_LONG_IDENTICAL(&columnType, 7);
	}
	_9 = _8;
	if (!(_9)) {
		_9 = ZEPHIR_IS_LONG_IDENTICAL(&columnType, 9);
	}
	if (_9) {
		zephir_cast_to_string(&_10$$5, &defaultValue);
		ZEPHIR_CPY_WRT(&preparedValue, &_10$$5);
	} else {
		...
		zephir_get_strval(&preparedValue, &_13$$6);
	}
