	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			if (Z_TYPE_P(&_50$$3) != IS_NULL) {
				...
				ZVAL_STRING(&_53$$38, "");
				ZEPHIR_CALL_FUNCTION(&_54$$38, "preg_replace", &_55, 43, &_52$$38, &_53$$38, &_51$$38);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_57$$38, "strcasecmp", &_58, 41, &_56$$38, &_52$$38);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &_61$$3, "__construct", &_62, 218, &columnName, &definition);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&_109$$41) != IS_NULL) {
					...
					ZVAL_STRING(&_112$$76, "");
					ZEPHIR_CALL_FUNCTION(&_113$$76, "preg_replace", &_55, 43, &_111$$76, &_112$$76, &_110$$76);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_115$$76, "strcasecmp", &_58, 41, &_114$$76, &_111$$76);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_118$$41, "__construct", &_62, 218, &columnName, &definition);
				zephir_check_call_status();
