		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arrayConfig), _1)
		{
			...
			if (_3$$3) {
				...
				if (ZEPHIR_IS_IDENTICAL(&_5$$5, &defaultAdapter_zv)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_6$$6, "__construct", &_7, 194);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_8$$6, &_6$$6, "load", &_9, 195, &configName);
					zephir_check_call_status();
			...
			if (ZEPHIR_IS_IDENTICAL(&_12$$3, &_11$$3)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_18$$10, "__construct", &_7, 194);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_19$$10, &_18$$10, "load", &_9, 195, &configInstance);
				zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (_20$$11) {
					...
					if (ZEPHIR_IS_IDENTICAL(&_21$$13, &defaultAdapter_zv)) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_22$$14, "__construct", &_7, 194);
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_23$$14, &_22$$14, "load", &_9, 195, &configName);
						zephir_check_call_status();
				...
				if (ZEPHIR_IS_IDENTICAL(&_26$$11, &_25$$11)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_30$$18, "__construct", &_7, 194);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_31$$18, &_30$$18, "load", &_9, 195, &configInstance);
					zephir_check_call_status();
