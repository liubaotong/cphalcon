...
PHP_METHOD(Phalcon_Encryption_Crypt, __construct)
{
	...
	if (Z_TYPE_P(padFactory) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, padFactory, "__construct", NULL, 230);
...
PHP_METHOD(Phalcon_Encryption_Crypt, decrypt)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval input_zv, key_zv, __$true, __$null, blockSize, cipher, cipherText, decrypted, decryptKey, digest, hashAlgorithm, hashLength, iv, ivLength, mode, padded, _0, _1, _6, _7, _2$$5, _3$$5, _4$$5, _5$$6, _8$$7;
	zend_string *input = NULL, *key = NULL;
	zval *this_ptr = getThis();
	...
	if (1 != ZEPHIR_IS_EMPTY(&key_zv)) {
		ZEPHIR_CPY_WRT(&decryptKey, &key_zv);
	}
	if (1 == ZEPHIR_IS_EMPTY(&decryptKey)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Decryption key cannot be empty", "phalcon/Encryption/Crypt.zep", 198);
		return;
	}
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&mode, this_ptr, "getmode", NULL, 231);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&blockSize, this_ptr, "getblocksize", NULL, 232, &mode);
	zephir_check_call_status();
	ZVAL_LONG(&_0, 0);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "8bit");
	ZEPHIR_CALL_FUNCTION(&iv, "mb_substr", NULL, 233, &input_zv, &_0, &ivLength, &_1);
	zephir_check_call_status();
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$5, "");
		ZEPHIR_CALL_FUNCTION(&_3$$5, "hash", NULL, 80, &hashAlgorithm, &_2$$5, &__$true);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&hashLength);
		ZVAL_LONG(&hashLength, zephir_fast_strlen_ev(&_3$$5));
		ZEPHIR_INIT_NVAR(&_2$$5);
		ZVAL_STRING(&_2$$5, "8bit");
		ZEPHIR_CALL_FUNCTION(&digest, "mb_substr", NULL, 233, &input_zv, &ivLength, &hashLength, &_2$$5);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$5);
		zephir_add_function(&_4$$5, &ivLength, &hashLength);
		ZEPHIR_INIT_NVAR(&_2$$5);
		ZVAL_STRING(&_2$$5, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 233, &input_zv, &_4$$5, &__$null, &_2$$5);
		zephir_check_call_status();
	} else {
		ZEPHIR_INIT_VAR(&_5$$6);
		ZVAL_STRING(&_5$$6, "8bit");
		ZEPHIR_CALL_FUNCTION(&cipherText, "mb_substr", NULL, 233, &input_zv, &ivLength, &__$null, &_5$$6);
		zephir_check_call_status();
	}
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_7)) {
		ZEPHIR_CALL_FUNCTION(&_8$$7, "hash_hmac", NULL, 234, &hashAlgorithm, &padded, &decryptKey, &__$true);
		zephir_check_call_status();
		if (!ZEPHIR_IS_IDENTICAL(&digest, &_8$$7)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_mismatch_ce, "Hash does not match.", "phalcon/Encryption/Crypt.zep", 247);
			return;
		}
	}
...
PHP_METHOD(Phalcon_Encryption_Crypt, decryptBase64)
{
	...
	zval *input_param = NULL, key_zv, *safe_param = NULL, _0$$3, _1$$3, _2$$3, _3$$3, _4$$3, _5;
	zval input;
	zval *this_ptr = getThis();
	...
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	input_param = ZEND_CALL_ARG(execute_data, 1);
	if (ZEND_NUM_ARGS() > 2) {
		safe_param = ZEND_CALL_ARG(execute_data, 3);
	}
	...
	ZEPHIR_CALL_FUNCTION(&_5, "base64_decode", NULL, 235, &input);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "decrypt", NULL, 0, &_5, &key_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, encrypt)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval input_zv, key_zv, __$true, blockSize, cipher, digest, encryptKey, encrypted, iv, ivLength, mode, padded, _0, _1, _2, _3$$8;
	zend_string *input = NULL, *key = NULL;
	zval *this_ptr = getThis();
	...
	if (1 != ZEPHIR_IS_EMPTY(&key_zv)) {
		ZEPHIR_CPY_WRT(&encryptKey, &key_zv);
	}
	if (1 == ZEPHIR_IS_EMPTY(&encryptKey)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Encryption key cannot be empty", "phalcon/Encryption/Crypt.zep", 305);
		return;
	}
	zephir_read_property(&_0, this_ptr, ZEND_STRL("cipher"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&cipher, &_0);
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("ValueError"))) {
			...
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Cannot calculate Random Pseudo Bytes", "phalcon/Encryption/Crypt.zep", 319);
			return;
		}
	}
	if (ZEPHIR_IS_FALSE_IDENTICAL(&iv)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Cannot calculate Random Pseudo Bytes", "phalcon/Encryption/Crypt.zep", 323);
		return;
	}
	...
	zephir_read_property(&_0, this_ptr, ZEND_STRL("useSigning"), PH_NOISY_CC | PH_READONLY);
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_CALL_METHOD(&_3$$8, this_ptr, "gethashalgorithm", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&digest, "hash_hmac", NULL, 234, &_3$$8, &padded, &encryptKey, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptBase64)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zend_bool safe;
	zval input_zv, key_zv, *safe_param = NULL, _0$$3, _1$$3, _2$$3, _3$$3, _4$$3, _5;
	zend_string *input = NULL, *key = NULL;
	zval *this_ptr = getThis();
	...
	if (safe) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "encrypt", NULL, 0, &input_zv, &key_zv);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_1$$3, "base64_encode", NULL, 236, &_0$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "encrypt", NULL, 0, &input_zv, &key_zv);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 236, &_5);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getAvailableHashAlgorithms)
{
	...
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_RETURN_CALL_FUNCTION("hash_hmac_algos", NULL, 237);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_RETURN_CALL_FUNCTION("hash_algos", NULL, 238);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, isValidDecryptLength)
{
	...
	RETURN_MM_BOOL(ZEPHIR_LE_LONG(&length, zephir_fast_strlen_ev(&input_zv)));
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setAuthData)
{
	...
	zephir_update_property_zval(this_ptr, ZEND_STRL("authData"), &data_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setAuthTag)
{
	...
	ZEND_PARSE_PARAMETERS_END();
	ZVAL_STR(&tag_zv, tag);
	zephir_update_property_zval(this_ptr, ZEND_STRL("authTag"), &tag_zv);
	RETURN_THISW();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, setCipher)
{
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getivlength", NULL, 239, &cipher_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, setHashAlgorithm)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval hashAlgorithm_zv, _0;
	zend_string *hashAlgorithm = NULL;
	zval *this_ptr = getThis();

	ZVAL_UNDEF(&hashAlgorithm_zv);
	ZVAL_UNDEF(&_0);
	ZEND_PARSE_PARAMETERS_START(1, 1)
	...
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, ZEND_STRL("hashAlgorithm"), &hashAlgorithm_zv);
	RETURN_THIS();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, checkCipherHashIsAvailable)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval cipher_zv, type_zv, available, lower, method, _0, _1$$5, _2$$5, _3$$5;
	zend_string *cipher = NULL, *type = NULL;
	zval *this_ptr = getThis();
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, &type_zv)) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&lower, "mb_strtolower", NULL, 7, &cipher_zv);
	zephir_check_call_status();
	if (1 != zephir_fast_in_array(&lower, &available)) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$5, "sprintf", NULL, 76, &_2$$5, &type_zv, &cipher_zv);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$5, "__construct", NULL, 35, &_3$$5);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$5, "phalcon/Encryption/Crypt.zep", 636);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Encryption_Crypt, cryptPadText)
{
	...
	zval input_zv, mode_zv, *blockSize_param = NULL, *paddingType_param = NULL, padding, service, _0, _2, _8, _9, _4$$3, _5$$3, _6$$3, _7$$3;
	...
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	blockSize_param = ZEND_CALL_ARG(execute_data, 3);
	paddingType_param = ZEND_CALL_ARG(execute_data, 4);
	ZVAL_STR_COPY(&input_zv, input);
	...
	ZVAL_STRING(&_2, "ecb");
	zephir_array_fast_append(&_1, &_2);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "checkismode", NULL, 240, &_1, &mode_zv);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		if (_3$$3) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Padding size cannot be less than 0 or greater than 256", "phalcon/Encryption/Crypt.zep", 669);
			return;
		}
	...
	ZEPHIR_CONCAT_VV(return_value, &input_zv, &_2);
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, cryptUnpadText)
{
	...
	if (_1) {
		...
		ZVAL_STRING(&_4, "ecb");
		zephir_array_fast_append(&_3, &_4);
		ZEPHIR_CALL_METHOD(&_2, this_ptr, "checkismode", NULL, 240, &_3, &mode_zv);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, decryptGetUnpadded)
{
	...
	zval mode_zv, *blockSize_param = NULL, decrypted, *decrypted_param = NULL, padding, _0, _2, _3$$3, _4$$3;
	...
	ZEND_PARSE_PARAMETERS_START(3, 3)
		Z_PARAM_STR(mode)
		Z_PARAM_LONG(blockSize)
		Z_PARAM_ZVAL(decrypted_param)
	ZEND_PARSE_PARAMETERS_END();
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	blockSize_param = ZEND_CALL_ARG(execute_data, 2);
	decrypted_param = ZEND_CALL_ARG(execute_data, 3);
	ZVAL_STR_COPY(&mode_zv, mode);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "cryptunpadtext", NULL, 0, &decrypted, &mode_zv, &_3$$3, &padding);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Encryption_Crypt, decryptGcmCcmAuth)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval mode_zv, cipherText_zv, decryptKey_zv, iv_zv, authData, authTag, authTagLength, cipher, encrypted, decrypted, _0, _1, _3, _4$$3, _5$$3, _6$$4;
	zend_string *mode = NULL, *cipherText = NULL, *decryptKey = NULL, *iv = NULL;
	zval *this_ptr = getThis();

	ZVAL_UNDEF(&mode_zv);
	ZVAL_UNDEF(&cipherText_zv);
	ZVAL_UNDEF(&decryptKey_zv);
	ZVAL_UNDEF(&iv_zv);
	ZVAL_UNDEF(&authData);
	ZVAL_UNDEF(&authTag);
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	ZVAL_STR_COPY(&mode_zv, mode);
	ZVAL_STR_COPY(&cipherText_zv, cipherText);
	ZVAL_STR_COPY(&decryptKey_zv, decryptKey);
	...
	ZVAL_STRING(&_3, "gcm");
	zephir_array_fast_append(&_2, &_3);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "checkismode", NULL, 240, &_2, &mode_zv);
	zephir_check_call_status();
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		zephir_substr(&authTag, &cipherText_zv, zephir_get_intval(&authTagLength), 0, ZEPHIR_SUBSTR_NO_LENGTH);
		ZEPHIR_INIT_VAR(&_5$$3);
		ZVAL_STRING(&_5$$3, "");
		ZEPHIR_INIT_VAR(&encrypted);
		zephir_fast_str_replace(&encrypted, &authTag, &_5$$3, &cipherText_zv);
		ZVAL_LONG(&_4$$3, 1);
		ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 241, &encrypted, &cipher, &decryptKey_zv, &_4$$3, &iv_zv, &authTag, &authData);
		zephir_check_call_status();
	} else {
		ZVAL_LONG(&_6$$4, 1);
		ZEPHIR_CALL_FUNCTION(&decrypted, "openssl_decrypt", NULL, 241, &cipherText_zv, &cipher, &decryptKey_zv, &_6$$4, &iv_zv);
		zephir_check_call_status();
	}
	if (ZEPHIR_IS_FALSE_IDENTICAL(&decrypted)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Could not decrypt data", "phalcon/Encryption/Crypt.zep", 810);
		return;
	}
	RETURN_CCTOR(&decrypted);
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptGetPadded)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long blockSize, ZEPHIR_LAST_CALL_STATUS;
	zval mode_zv, input_zv, *blockSize_param = NULL, _0, _2, _4, _5$$3, _6$$3;
	zend_string *mode = NULL, *input = NULL;
	zval *this_ptr = getThis();
...
PHP_METHOD(Phalcon_Encryption_Crypt, encryptGcmCcm)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval mode_zv, padded_zv, encryptKey_zv, iv_zv, authData, authTag, authTagLength, cipher, encrypted, _0, _1, _3, _4$$3, _5$$5;
	zend_string *mode = NULL, *padded = NULL, *encryptKey = NULL, *iv = NULL;
	zval *this_ptr = getThis();

	ZVAL_UNDEF(&mode_zv);
	ZVAL_UNDEF(&padded_zv);
	ZVAL_UNDEF(&encryptKey_zv);
	ZVAL_UNDEF(&iv_zv);
	ZVAL_UNDEF(&authData);
	ZVAL_UNDEF(&authTag);
	ZVAL_UNDEF(&authTagLength);
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	ZVAL_STR_COPY(&mode_zv, mode);
	ZVAL_STR_COPY(&padded_zv, padded);
	ZVAL_STR_COPY(&encryptKey_zv, encryptKey);
	ZVAL_STR_COPY(&iv_zv, iv);
	zephir_read_property(&_0, this_ptr, ZEND_STRL("cipher"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CPY_WRT(&cipher, &_0);
	ZEPHIR_INIT_VAR(&authTag);
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_1)) {
		...
		if (1 == ZEPHIR_IS_EMPTY(&authData)) {
			ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Auth data must be provided when using AEAD mode", "phalcon/Encryption/Crypt.zep", 869);
			return;
		}
		...
		ZEPHIR_CALL_FUNCTION(&encrypted, "openssl_encrypt", NULL, 242, &padded_zv, &cipher, &encryptKey_zv, &_4$$3, &iv_zv, &authTag, &authData, &authTagLength);
		ZEPHIR_UNREF(&authTag);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, ZEND_STRL("authTag"), &authTag);
	} else {
		ZVAL_LONG(&_5$$5, 1);
		ZEPHIR_CALL_FUNCTION(&encrypted, "openssl_encrypt", NULL, 242, &padded_zv, &cipher, &encryptKey_zv, &_5$$5, &iv_zv);
		zephir_check_call_status();
	}
	if (ZEPHIR_IS_FALSE_IDENTICAL(&encrypted)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Could not encrypt data", "phalcon/Encryption/Crypt.zep", 898);
		return;
	}
...
PHP_METHOD(Phalcon_Encryption_Crypt, initializeAvailableCiphers)
{
	...
	zephir_check_call_status();
	if (!ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "This class requires the openssl extension for PHP", "phalcon/Encryption/Crypt.zep", 920);
		return;
	}
	ZEPHIR_CALL_FUNCTION(&available, "openssl_get_cipher_methods", NULL, 243, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&allowed);
	array_init(&allowed);
	zephir_is_iterable(&available, 0, "phalcon/Encryption/Crypt.zep", 937);
...
PHP_METHOD(Phalcon_Encryption_Crypt, checkIsMode)
{
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_string *mode = NULL;
	zval *modes_param = NULL, mode_zv;
	zval modes;

	ZVAL_UNDEF(&modes);
	ZVAL_UNDEF(&mode_zv);
	ZEND_PARSE_PARAMETERS_START(2, 2)
		ZEPHIR_Z_PARAM_ARRAY(modes, modes_param)
		Z_PARAM_STR(mode)
	ZEND_PARSE_PARAMETERS_END();
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	modes_param = ZEND_CALL_ARG(execute_data, 1);
	zephir_get_arrval(&modes, modes_param);
	ZVAL_STR_COPY(&mode_zv, mode);
	RETURN_MM_BOOL(zephir_fast_in_array(&mode_zv, &modes));
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getBlockSize)
{
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "");
	ZEPHIR_CALL_FUNCTION(&_4, "str_ireplace", NULL, 244, &_1, &_3, &_2);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getivlength", NULL, 239, &_4);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getIvLength)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	ZVAL_STR_COPY(&cipher_zv, cipher);
	ZEPHIR_CALL_FUNCTION(&length, "openssl_cipher_iv_length", NULL, 245, &cipher_zv);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&length)) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_encryption_crypt_exception_exception_ce, "Cannot calculate the initialization vector (IV) length of the cipher", "phalcon/Encryption/Crypt.zep", 990);
		return;
	}
	RETURN_CCTOR(&length);
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, getMode)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "-");
	ZEPHIR_CALL_FUNCTION(&_2, "strrpos", NULL, 246, &_0, &_1);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_FUNCTION("mb_strtolower", NULL, 7, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, phpOpensslCipherIvLength)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	ZVAL_STR_COPY(&cipher_zv, cipher);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_cipher_iv_length", NULL, 245, &cipher_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Encryption_Crypt, phpOpensslRandomPseudoBytes)
{
	...
	ZVAL_LONG(&_0, length);
	ZEPHIR_RETURN_CALL_FUNCTION("openssl_random_pseudo_bytes", NULL, 247, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
