...
PHP_METHOD(Phalcon_Annotations_Reflection, getClassAnnotations)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		if (zephir_array_isset_string_fetch(&reflectionClass, &_1$$3, SL("class"), 0)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", NULL, 40, &reflectionClass);
		...
		if (_1$$3) {
			...
			if (Z_TYPE_P(&reflectionConstants) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&reflectionConstants), _4$$4, _5$$4, _2$$4)
				{
					...
					ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", &_7, 40, &reflectionConstant);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(NULL, &_8$$6, "__construct", &_7, 40, &reflectionConstant);
						zephir_check_call_status();
		...
		if (_1$$3) {
			...
			if (Z_TYPE_P(&reflectionProperties) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&reflectionProperties), _4$$4, _5$$4, _2$$4)
				{
					...
					ZEPHIR_INIT_NVAR(&_6$$5);
					object_init_ex(&_6$$5, phalcon_annotations_collection_ce);
					ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", &_7, 40, &reflectionProperty);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&_8$$6);
						object_init_ex(&_8$$6, phalcon_annotations_collection_ce);
						ZEPHIR_CALL_METHOD(NULL, &_8$$6, "__construct", &_7, 40, &reflectionProperty);
						zephir_check_call_status();
		...
		if (_1$$3) {
			...
			if (Z_TYPE_P(&reflectionMethods) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&reflectionMethods), _4$$4, _5$$4, _2$$4)
				{
					...
					ZEPHIR_INIT_NVAR(&_6$$5);
					object_init_ex(&_6$$5, phalcon_annotations_collection_ce);
					ZEPHIR_CALL_METHOD(NULL, &_6$$5, "__construct", &_7, 40, &reflectionMethod);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_INIT_NVAR(&_8$$6);
						object_init_ex(&_8$$6, phalcon_annotations_collection_ce);
						ZEPHIR_CALL_METHOD(NULL, &_8$$6, "__construct", &_7, 40, &reflectionMethod);
						zephir_check_call_status();
