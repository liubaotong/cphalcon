...
PHP_METHOD(Phalcon_Annotations_Adapter_Stream, read)
{
	...
	zval key_zv, __$false, contents, version, _0, _1, _2, _3, _4, _5, _6, _11, _7$$5, _8$$5, _9$$6, _10$$6;
	...
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, ">=");
	ZEPHIR_CALL_FUNCTION(&_6, "version_compare", NULL, 137, &version, &_4, &_5);
	zephir_check_call_status();
	if (zephir_is_true(&_6)) {
		...
		ZVAL_LONG(&_8$$5, 2);
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 138, &_7$$5, &_8$$5);
		zephir_check_call_status();
	} else {
		...
		ZVAL_LONG(&_10$$6, 2);
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 138, &_9$$6, &_10$$6);
		zephir_check_call_status();
	}
