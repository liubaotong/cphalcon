...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, getKeys)
{
	...
	zephir_method_globals *ZEPHIR_METHOD_GLOBALS_PTR = NULL;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval prefix_zv, item, pattern, apc, _0, _2$$4;
	...
	for (;_1->funcs->valid(_1) == SUCCESS && !EG(exception); _1->funcs->move_forward(_1)) {
		...
		zephir_array_fetch_string(&_2$$4, &item, SL("key"), PH_NOISY | PH_READONLY, "phalcon/Storage/Adapter/Apcu.zep", 91);
		zephir_array_append(&results, &_2$$4, PH_SEPARATE, "phalcon/Storage/Adapter/Apcu.zep", 91);
	}
	zend_iterator_dtor(_1);
	RETURN_CTOR(&results);
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, doDeleteMultiple)
{
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *keys_param = NULL, prefixedKeys, key, result, *_0, _1, _2$$3, _4$$4;
	zval keys;
	zval *this_ptr = getThis();

	ZVAL_UNDEF(&keys);
	ZVAL_UNDEF(&prefixedKeys);
	ZVAL_UNDEF(&key);
	ZVAL_UNDEF(&result);
	ZVAL_UNDEF(&_1);
	ZVAL_UNDEF(&_2$$3);
	...
	zephir_is_iterable(&keys, 0, "phalcon/Storage/Adapter/Apcu.zep", 157);
	if (Z_TYPE_P(&keys) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&keys), _0)
		{
			ZEPHIR_INIT_NVAR(&key);
			ZVAL_COPY(&key, _0);
			ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getprefixedkey", &_3, 0, &key);
			zephir_check_call_status();
			zephir_array_append(&prefixedKeys, &_2$$3, PH_SEPARATE, "phalcon/Storage/Adapter/Apcu.zep", 154);
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "getprefixedkey", &_3, 0, &key);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, phpApcuDec)
{
	...
	ZVAL_LONG(&_0, step);
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_dec", NULL, 113, key, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, phpApcuDelete)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_delete", NULL, 114, key);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, phpApcuExists)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 1, 0, &key);
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_exists", NULL, 115, key);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, phpApcuInc)
{
	...
	ZVAL_LONG(&_0, step);
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_inc", NULL, 116, key, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, phpApcuFetch)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 1, 0, &key);
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_fetch", NULL, 117, key);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Apcu, phpApcuStore)
{
	...
	ZVAL_LONG(&_0, ttl);
	ZEPHIR_RETURN_CALL_FUNCTION("apcu_store", NULL, 118, key, payload, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
