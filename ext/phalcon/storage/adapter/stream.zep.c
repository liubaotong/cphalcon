...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, clear)
{
	...
	ZEPHIR_CALL_METHOD(&directory, this_ptr, "getdirseparator", NULL, 122, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, delete)
{
	...
	ZEPHIR_CALL_METHOD(&filepath, this_ptr, "getfilepath", NULL, 124, &key_zv);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&result, "unlink", NULL, 125, &filepath);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, get)
{
	...
	if (!(_4)) {
		ZEPHIR_CALL_METHOD(&_5, this_ptr, "isexpired", NULL, 127, &payload);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, has)
{
	...
	ZEPHIR_CALL_METHOD(&_7, this_ptr, "isexpired", NULL, 127, &payload);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, set)
{
	...
	ZEPHIR_CALL_METHOD(&result, this_ptr, "storepayload", NULL, 129, &payload, &key_zv);
	zephir_check_call_status();
	zephir_read_property(&_7, this_ptr, ZEND_STRL("eventType"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_8);
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, setForever)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "storepayload", NULL, 129, &payload, &key_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getFilepath)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	ZVAL_STR_COPY(&key_zv, key);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getdir", NULL, 128, &key_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getPayload)
{
	...
	ZVAL_LONG(&_1, 8);
	ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 135, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_3, "unserialize", NULL, 16, &payload);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, storePayload)
{
	...
	ZEPHIR_CALL_METHOD(&directory, this_ptr, "getdir", NULL, 128, &key_zv);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, phpFilePutContents)
{
	...
	ZVAL_LONG(&_0, flags);
	ZEPHIR_RETURN_CALL_FUNCTION("file_put_contents", NULL, 139, &filename_zv, data, &_0, context);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, phpFopen)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("fopen", NULL, 140, &filename_zv, &mode_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, phpUnlink)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	ZVAL_STR_COPY(&filename_zv, filename);
	ZEPHIR_RETURN_CALL_FUNCTION("unlink", NULL, 125, &filename_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Phalcon_Storage_Adapter_Stream, getDirFromFile)
{
	...
	ZEPHIR_INIT_VAR(&_7);
	ZVAL_LONG(&_8, 2);
	ZEPHIR_CALL_FUNCTION(&_9, "str_split", NULL, 90, &start, &_8);
	zephir_check_call_status();
