...
PHP_METHOD(Phalcon_Support_Helper_Str_Concat, __invoke)
{
	...
	ZEPHIR_CALL_FUNCTION(&delimiter, "reset", NULL, 505, &arguments);
	...
	ZEPHIR_MAKE_REF(&arguments);
	ZEPHIR_CALL_FUNCTION(&first, "reset", NULL, 505, &arguments);
	ZEPHIR_UNREF(&arguments);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(&arguments);
	ZEPHIR_CALL_FUNCTION(&last, "end", NULL, 347, &arguments);
	ZEPHIR_UNREF(&arguments);
	zephir_check_call_status();
