...
PHP_METHOD(Phalcon_Support_Debug_Dump, output)
{
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		if (zephir_instance_of_ev(variable, phalcon_di_diinterface_ce)) {
			...
			ZEPHIR_CALL_FUNCTION(&_46$$12, "get_object_vars", NULL, 432, variable);
			zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_153$$28, "mb_strlen", NULL, 246, variable);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_157$$29, "mb_strlen", NULL, 246, variable);
		zephir_check_call_status();
