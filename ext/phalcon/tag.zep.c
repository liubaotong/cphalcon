...
PHP_METHOD(Phalcon_Tag, preload)
{
	...
	if (_1) {
		...
		ZEPHIR_CALL_METHOD(NULL, &link, "__construct", NULL, 506, &_8$$5, &_5$$5, &attributes);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_9$$5, &_8$$5, "serialize", NULL, 507, &_10$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Tag, textArea)
{
	...
	ZEPHIR_CALL_SELF(&code, "renderattributes", NULL, 0, &_1, &params);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "htmlspecialchars", NULL, 289, &content);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
